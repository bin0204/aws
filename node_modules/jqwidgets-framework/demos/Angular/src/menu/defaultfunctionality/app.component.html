<div #jqxWidget style="height: 300px;">
  ...
  <div style="margin-left: 60px;  margin-top: 120px;">
    ...
    <div style="margin-top: 20px; font-size: 14px; font-family: Verdana Arial; float: left;">
      <jqxCheckBox (onChange)="animationOnChange($event)"
                   [width]="150" [height]="20" [checked]="true">
        Enable Animation
      </jqxCheckBox>
      <div style="margin-top: 20px;">
        <jqxCheckBox style="margin-top: 20px;" (onChange)="disabledOnChange($event)"
    ...
    <div style="margin-top: 20px; margin-left: 60px; font-size: 14px; font-family: Verdana Arial; float: left;">
      <jqxCheckBox (onChange)="hoverOnChange($event)"
                   [width]="150" [height]="20" [checked]="true">
        Enable Hover
      </jqxCheckBox>
      <div style="margin-top: 20px;">
        <jqxCheckBox (onChange)="openOnChange($event)"
                     [width]="150" [height]="20" [checked]="true">
          Auto Open
        </jqxCheckBox>
      </div>
    ...
    <div style="margin-top: 20px; margin-left: 60px; font-size: 14px; font-family: Verdana Arial; float: left;">
      <jqxCheckBox (onChange)="topLevelArrowsOnChange($event)"
                   [width]="200" [height]="20">
